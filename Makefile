...
deploy-$(TARGET-NET10):
	-dotnet publish -c $(BUILD_CONFIG) -f $(TARGET-NET10) \
		-p:PublishDir=..\$(ARTIFACTS_BASEDIR)\$(ARTIFACTS_SUBDIR_BASENAME)-$(TARGET-NET10) \
		$(MAIN_PROJECT_FILE)
	-$(RM) $(ARTIFACTS_BASEDIR)\$(ARTIFACTS_SUBDIR_BASENAME)-$(TARGET-NET10)\*.pdb \
		$(ARTIFACTS_BASEDIR)\$(ARTIFACTS_SUBDIR_BASENAME)-$(TARGET-NET10)\*.xml \
		$(ARTIFACTS_BASENAME)-$(TARGET-NET10).zip 2>NUL
	cd $(ARTIFACTS_BASEDIR)
	powershell Compress-Archive -Path $(ARTIFACTS_SUBDIR_BASENAME)-$(TARGET-NET10) -DestinationPath ..\$(ARTIFACTS_BASENAME)-$(TARGET-NET10).zip
	cd $(MAKEDIR)
